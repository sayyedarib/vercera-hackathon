...
const services = [
    {
        id: 1,
        icon: <MdFastfood style = {{ fill: gradient }} />,
        title: "Donate food",
    ...
    {
        id: 2,
        icon: <GiClothes style = {{ fill: gradient }} />,
        title: "Donate Cloths",
        text: "Lorem ipsum dolor sit mattis amet consectetur adipiscing",
    ...
    {
        id: 3,
        icon: <MdBloodtype style = {{ fill: gradient }} />,
        title: "Donate Blood",
        text: "Lorem ipsum dolor sit mattis amet consectetur adipiscing"
    ...
    {
        id: 4, 
        icon: <BiDonateBlood style = {{ fill: gradient }} />,
        title: "Get Blood",
        text: "Lorem ipsum dolor sit mattis amet consectetur adipiscing"
    ...
    {
        id: 5,
        icon: <FaRupeeSign style = {{ fill: gradient }} />,
        title: "Need Money",
        text: "Lorem ipsum dolor sit mattis amet consectetur adipiscing"
